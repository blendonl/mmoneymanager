...
class CreateExpenseCategoryDto {
    ...
    parentId;
    isConnectedToStore;
    constructor(name, isConnectedToStore, parentId) {
        this.name = name;
...
], CreateExpenseCategoryDto.prototype, "parentId", void 0);
__decorate([
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CreateExpenseCategoryDto.prototype, "isConnectedToStore", void 0);
